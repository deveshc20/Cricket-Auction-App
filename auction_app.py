...
# ---------- SESSION INIT ----------
if 'player_index' not in st.session_state: st.session_state['player_index'] = 0
if 'teams' not in st.session_state: st.session_state['teams'] = []
if 'auction_results' not in st.session_state: st.session_state['auction_results'] = []
